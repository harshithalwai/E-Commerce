          ...
          <div className="hidden sm:block overflow-x-auto scrollbar-hide">
            <ul className="flex gap-3 sm:gap-6 text-gray-700 font-semibold whitespace-nowrap pb-1">
              {navList.map((item) => (
                <li key={item} className="flex-shrink-0 relative">
                  <ButtonBase
                    component={Link}
                    to={`/${item.toLowerCase()}`}
                    className="!px-2 !py-1 !rounded-md hover:bg-gray-200 transition-all duration-200 text-sm link relative"
                  >
                    {item}
                  </ButtonBase>
                </li>
              ...
              <li className="flex-shrink-0 ">
                ...
                <ul className="absolute top-[96%] bg-white min-w-[150px] mt-2 flex flex-col gap-2">
                  <li className="w-full">
                    <Button
                      component={Link}
                      to="/fashion"
                      className="!capitalize w-full  hover:!text-[#ff5252] hover:bg-gray-200 rounded-md !justify-start !text-left !px-3 !font-[500] !text-[rgba(0,0,0,0.8)]"
                    >
                      Item 1
                    </Button>
                  </li>
